...
- [`ERC1155`](https://github.com/latticexyz/mud/tree/main/packages/world-modules/src/modules/erc1155-puppet) - installs an ERC1155 token into a namespace in a World.
